...
#ifdef SPINE_CLOHTING
sampler2D _SpineClothingColorMask;
#endif
...
fixed4 frag (VertexOutput IN) : SV_Target
{
	...
	#ifdef SPINE_CLOHTING
	half4 maskColor = tex2D(_SpineClothingColorMask, IN.texcoord);
	color.rgb = color.rgb * maskColor.rgb * color.a;
	#endif
