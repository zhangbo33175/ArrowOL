...
namespace CSObjectWrapEditor
{
...
#else
        public static string common_path = Application.dataPath + "/Framework/ThirdLibs/XLua/Gen/";
#endif
    ...
    public static class Generator
    {
        ...
        static bool isMethodInBlackList(MethodBase mb)
        {
            ...
            if (mb.GetParameters().Any(pInfo => pInfo.ParameterType.IsByRefLike)) return true;  // by taoye
...
#pragma warning restore 618
        ...
        //[MenuItem("Solar/XLua/Generate Code", false, 241)]  // by taoye
        ...
        [MenuItem("Solar/ReGenerate XLua Codes", false, 250)]  // by taoye
