...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeCollider3DLifeCyclesBehaviourWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Honor.Runtime.Collider3DLifeCyclesBehaviour gen_ret = new Honor.Runtime.Collider3DLifeCyclesBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.Collider3DLifeCyclesBehaviour constructor!");
