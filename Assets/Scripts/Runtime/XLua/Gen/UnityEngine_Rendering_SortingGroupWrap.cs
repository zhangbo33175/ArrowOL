...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRenderingSortingGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.Rendering.SortingGroup);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "sortAtRoot", _g_get_sortAtRoot);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "sortAtRoot", _s_set_sortAtRoot);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "UpdateAllSortingGroups", _m_UpdateAllSortingGroups_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.Rendering.SortingGroup gen_ret = new UnityEngine.Rendering.SortingGroup();
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_UpdateAllSortingGroups_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        static int _g_get_sortingLayerName(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Rendering.SortingGroup gen_to_be_invoked = (UnityEngine.Rendering.SortingGroup)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_sortAtRoot(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Rendering.SortingGroup gen_to_be_invoked = (UnityEngine.Rendering.SortingGroup)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.sortAtRoot);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_sortAtRoot(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Rendering.SortingGroup gen_to_be_invoked = (UnityEngine.Rendering.SortingGroup)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sortAtRoot = LuaAPI.lua_toboolean(L, 2);
