        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.Events.UnityEvent<UnityEngine.Vector2> gen_ret = new UnityEngine.Events.UnityEvent<UnityEngine.Vector2>();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Events.UnityEvent<UnityEngine.Vector2> constructor!");
