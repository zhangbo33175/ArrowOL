...
namespace XLua.CSObjectWrap
{
    ...
    public class GameLibJsonHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameLib.JsonHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "GameLib.JsonHelper does not have a constructor!");
        }
        ...
        static int _m_ToJson_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    bool _isPrettyPrint = LuaAPI.lua_toboolean(L, 2);
                    
                        string gen_ret = GameLib.JsonHelper.ToJson( _obj, _isPrettyPrint );
                ...
                if(gen_param_count == 1&& translator.Assignable<object>(L, 1)) 
                {
                    object _obj = translator.GetObject(L, 1, typeof(object));
                        ...
                        string gen_ret = GameLib.JsonHelper.ToJson( _obj );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameLib.JsonHelper.ToJson!");
		    ...
		    try {
                ...
                
                {
                    ...
                    string _json = LuaAPI.lua_tostring(L, 2);
                        ...
                        object gen_ret = GameLib.JsonHelper.ToObject( _objectType, _json );
