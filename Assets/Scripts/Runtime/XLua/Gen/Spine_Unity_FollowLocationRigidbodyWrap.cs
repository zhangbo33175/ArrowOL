...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineUnityFollowLocationRigidbodyWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.Unity.FollowLocationRigidbody);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Spine.Unity.FollowLocationRigidbody gen_ret = new Spine.Unity.FollowLocationRigidbody();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.Unity.FollowLocationRigidbody constructor!");
        ...
        static int _g_get_reference(RealStatePtr L)
        {
		    try {
                ...
                Spine.Unity.FollowLocationRigidbody gen_to_be_invoked = (Spine.Unity.FollowLocationRigidbody)translator.FastGetCSObj(L, 1);
