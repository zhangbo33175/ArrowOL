...
namespace XLua.CSObjectWrap
{
    ...
    public class GameLibTablesBridgeTableCustomizeItemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameLib.TablesBridge.TableCustomizeItem);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					GameLib.TablesBridge.TableCustomizeItem gen_ret = new GameLib.TablesBridge.TableCustomizeItem();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameLib.TablesBridge.TableCustomizeItem constructor!");
        ...
        static int _g_get_ID(RealStatePtr L)
        {
		    try {
                ...
                GameLib.TablesBridge.TableCustomizeItem gen_to_be_invoked = (GameLib.TablesBridge.TableCustomizeItem)translator.FastGetCSObj(L, 1);
