...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeGamePathUtilsTableWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Honor.Runtime.GamePathUtils.Table);
        ...
        {
            return LuaAPI.luaL_error(L, "Honor.Runtime.GamePathUtils.Table does not have a constructor!");
        }
        ...
        static int _m_GetLuaScriptRootDirectoryFullPath_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string gen_ret = Honor.Runtime.GamePathUtils.Table.GetLuaScriptRootDirectoryFullPath(  );
        ...
        static int _m_GetExcelRootDirectoryFullPath_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string gen_ret = Honor.Runtime.GamePathUtils.Table.GetExcelRootDirectoryFullPath(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
