...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeAorTextEffectSpacingLineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Honor.Runtime.AorTextEffectSpacing.Line);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					Honor.Runtime.AorTextEffectSpacing.Line gen_ret = new Honor.Runtime.AorTextEffectSpacing.Line(_startVertexIndex, _length);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.AorTextEffectSpacing.Line constructor!");
        ...
        static int _g_get_StartVertexIndex(RealStatePtr L)
        {
		    try {
                ...
                Honor.Runtime.AorTextEffectSpacing.Line gen_to_be_invoked = (Honor.Runtime.AorTextEffectSpacing.Line)translator.FastGetCSObj(L, 1);
