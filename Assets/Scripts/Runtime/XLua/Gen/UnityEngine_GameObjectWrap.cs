...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 23, 9, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentNoAlloc", _m_GetComponentNoAlloc);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetParticleSortOrder", _m_SetParticleSortOrder);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentNoAlloc(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.GetComponentNoAlloc( _type );
                        translator.Push(L, gen_ret);
        ...
        static int _m_InScene(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        bool gen_ret = gen_to_be_invoked.InScene(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetParticleSortOrder(RealStatePtr L)
        {
		    try {
