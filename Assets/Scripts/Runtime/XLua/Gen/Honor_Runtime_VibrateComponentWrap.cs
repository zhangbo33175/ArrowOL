...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeVibrateComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Honor.Runtime.VibrateComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Honor.Runtime.VibrateComponent gen_ret = new Honor.Runtime.VibrateComponent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.VibrateComponent constructor!");
        ...
        static int _m_Play(RealStatePtr L)
        {
		    try {
                ...
                Honor.Runtime.VibrateComponent gen_to_be_invoked = (Honor.Runtime.VibrateComponent)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.VibrateComponent.Play!");
        ...
        static int _m_PlayCustom(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    gen_to_be_invoked.PlayCustom( _intensity, _sharpness, _preDuration, _duration );
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    gen_to_be_invoked.PlayCustom( _intensity, _sharpness, _preDuration );
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.PlayCustom( _intensity, _sharpness );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.VibrateComponent.PlayCustom!");
        ...
        static int _m_PlayEmphasis(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    gen_to_be_invoked.PlayEmphasis( _amplitude, _frequency, _preDuration, _interval );
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    gen_to_be_invoked.PlayEmphasis( _amplitude, _frequency, _preDuration );
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.PlayEmphasis( _amplitude, _frequency );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.VibrateComponent.PlayEmphasis!");
