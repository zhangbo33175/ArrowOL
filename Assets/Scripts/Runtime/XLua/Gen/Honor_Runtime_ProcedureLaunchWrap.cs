...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeProcedureLaunchWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Honor.Runtime.ProcedureLaunch);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Honor.Runtime.ProcedureLaunch gen_ret = new Honor.Runtime.ProcedureLaunch();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.ProcedureLaunch constructor!");
        ...
        static int _m_OnInit(RealStatePtr L)
        {
		    try {
                ...
                Honor.Runtime.ProcedureLaunch gen_to_be_invoked = (Honor.Runtime.ProcedureLaunch)translator.FastGetCSObj(L, 1);
