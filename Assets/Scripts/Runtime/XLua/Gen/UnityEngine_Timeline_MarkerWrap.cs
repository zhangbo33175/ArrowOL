...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTimelineMarkerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Timeline.Marker);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.Timeline.Marker does not have a constructor!");
        }
        ...
        static int _m_OnInitialize(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Timeline.Marker gen_to_be_invoked = (UnityEngine.Timeline.Marker)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    UnityEngine.Timeline.TrackAsset _aPent = (UnityEngine.Timeline.TrackAsset)translator.GetObject(L, 2, typeof(UnityEngine.Timeline.TrackAsset));
                    
                    gen_to_be_invoked.OnInitialize( _aPent );
