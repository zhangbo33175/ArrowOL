        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.List<UnityEngine.GameObject> gen_ret = new System.Collections.Generic.List<UnityEngine.GameObject>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.List<UnityEngine.GameObject> gen_ret = new System.Collections.Generic.List<UnityEngine.GameObject>(_capacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEnumerable<UnityEngine.GameObject>>(L, 2))
				{
					...
					System.Collections.Generic.List<UnityEngine.GameObject> gen_ret = new System.Collections.Generic.List<UnityEngine.GameObject>(_collection);
					translator.Push(L, gen_ret);
        ...
        static int _m_AsReadOnly(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.ObjectModel.ReadOnlyCollection<UnityEngine.GameObject> gen_ret = gen_to_be_invoked.AsReadOnly(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Predicate<UnityEngine.GameObject> _match = translator.GetDelegate<System.Predicate<UnityEngine.GameObject>>(L, 2);
                        ...
                        UnityEngine.GameObject gen_ret = gen_to_be_invoked.Find( _match );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Predicate<UnityEngine.GameObject> _match = translator.GetDelegate<System.Predicate<UnityEngine.GameObject>>(L, 2);
                        ...
                        System.Collections.Generic.List<UnityEngine.GameObject> gen_ret = gen_to_be_invoked.FindAll( _match );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Predicate<UnityEngine.GameObject> _match = translator.GetDelegate<System.Predicate<UnityEngine.GameObject>>(L, 2);
                        ...
                        UnityEngine.GameObject gen_ret = gen_to_be_invoked.FindLast( _match );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.Generic.List<UnityEngine.GameObject>.Enumerator gen_ret = gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        System.Collections.Generic.List<UnityEngine.GameObject> gen_ret = gen_to_be_invoked.GetRange( _index, _count );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ToArray(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.GameObject[] gen_ret = gen_to_be_invoked.ToArray(  );
                        translator.Push(L, gen_ret);
