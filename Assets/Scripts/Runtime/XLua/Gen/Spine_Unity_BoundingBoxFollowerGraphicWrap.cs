...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineUnityBoundingBoxFollowerGraphicWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Spine.Unity.BoundingBoxFollowerGraphic);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Spine.Unity.BoundingBoxFollowerGraphic gen_ret = new Spine.Unity.BoundingBoxFollowerGraphic();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.Unity.BoundingBoxFollowerGraphic constructor!");
        ...
        static int _m_Initialize(RealStatePtr L)
        {
		    try {
                ...
                Spine.Unity.BoundingBoxFollowerGraphic gen_to_be_invoked = (Spine.Unity.BoundingBoxFollowerGraphic)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Spine.Unity.BoundingBoxFollowerGraphic.Initialize!");
