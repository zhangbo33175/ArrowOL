...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeFileFragmentForWebGLManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Honor.Runtime.FileFragmentForWebGLManager);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Honor.Runtime.FileFragmentForWebGLManager gen_ret = new Honor.Runtime.FileFragmentForWebGLManager();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.FileFragmentForWebGLManager constructor!");
        ...
        static int _m_Load(RealStatePtr L)
        {
		    try {
                ...
                Honor.Runtime.FileFragmentForWebGLManager gen_to_be_invoked = (Honor.Runtime.FileFragmentForWebGLManager)translator.FastGetCSObj(L, 1);
        ...
        static int _m_GetAllItemNames(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.FileFragmentForWebGLManager.GetAllItemNames!");
        ...
        static int _m_GetBool(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.FileFragmentForWebGLManager.GetBool!");
        ...
        static int _m_GetInt(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.FileFragmentForWebGLManager.GetInt!");
        ...
        static int _m_GetFloat(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.FileFragmentForWebGLManager.GetFloat!");
        ...
        static int _m_GetString(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.FileFragmentForWebGLManager.GetString!");
