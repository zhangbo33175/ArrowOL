...
namespace XLua.CSObjectWrap
{
    ...
    public class RMapChapterTypeDataWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					RMapChapterTypeData gen_ret = new RMapChapterTypeData();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to RMapChapterTypeData constructor!");
        ...
        static int _s_set_m_MapObjectData(RealStatePtr L)
        {
		    try {
                ...
                RMapChapterTypeData gen_to_be_invoked = (RMapChapterTypeData)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.m_MapObjectData = (System.Collections.Generic.List<RMapData>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<RMapData>));
