...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetRaycastHit3DTransform", _m_GetRaycastHit3DTransform);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetRaycastHit3DTransform(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.Camera _camera = (UnityEngine.Camera)translator.GetObject(L, 2, typeof(UnityEngine.Camera));
                        ...
                        UnityEngine.Transform gen_ret = gen_to_be_invoked.GetRaycastHit3DTransform( _camera );
