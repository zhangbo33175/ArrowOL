...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeGestures3DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Honor.Runtime.Gestures3D);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Honor.Runtime.Gestures3D gen_ret = new Honor.Runtime.Gestures3D();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.Gestures3D constructor!");
        ...
        static int _m_ResetSwipe(RealStatePtr L)
        {
		    try {
                ...
                Honor.Runtime.Gestures3D gen_to_be_invoked = (Honor.Runtime.Gestures3D)translator.FastGetCSObj(L, 1);
