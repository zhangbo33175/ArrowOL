...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeAorTextEffectSpacingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Honor.Runtime.AorTextEffectSpacing);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Honor.Runtime.AorTextEffectSpacing gen_ret = new Honor.Runtime.AorTextEffectSpacing();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.AorTextEffectSpacing constructor!");
        ...
        static int _m_ModifyMesh(RealStatePtr L)
        {
		    try {
                ...
                Honor.Runtime.AorTextEffectSpacing gen_to_be_invoked = (Honor.Runtime.AorTextEffectSpacing)translator.FastGetCSObj(L, 1);
