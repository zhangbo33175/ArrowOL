...
namespace XLua.CSObjectWrap
{
    ...
    public class HonorRuntimeUILauncherViewWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Honor.Runtime.UILauncherView gen_ret = new Honor.Runtime.UILauncherView();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Honor.Runtime.UILauncherView constructor!");
        ...
        static int _g_get_DurationOverCallback(RealStatePtr L)
        {
		    try {
                ...
                translator.Push(L, gen_to_be_invoked.DurationOverCallback);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_DurationOverCallback(RealStatePtr L)
        {
		    try {
                ...
                Honor.Runtime.UILauncherView gen_to_be_invoked = (Honor.Runtime.UILauncherView)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.DurationOverCallback = translator.GetDelegate<System.Action>(L, 2);
