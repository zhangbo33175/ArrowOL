...
namespace Honor.Runtime
{
    public sealed class UIFloatWordsBehaviour : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private TextMeshProUGUI m_WordsTextTMP;
        public TextMeshProUGUI WordsTextTMP
        {
            get
            {
                return m_WordsTextTMP;
            }
        }
        ...
        /// </summary>
        [SerializeField]
        private Image m_BottomMaskLayer;
        public Image BottomMaskLayer
        {
            get
            {
                return m_BottomMaskLayer;
            }
        }
        ...
        private void Start()
        {
            ...
            if(m_WordsText && m_WordsText.enabled)
            {
                ...
                DOTween.Sequence().Append(m_WordsText.DOColor(new Color(m_WordsText.color.r, m_WordsText.color.g, m_WordsText.color.b, 1f), fadeDuration))
                ...
                DOTween.Sequence().AppendInterval(fadeDuration + m_Duration).
                                   Append(m_WordsText.DOColor(new Color(m_WordsText.color.r, m_WordsText.color.g, m_WordsText.color.b, 0f), fadeDuration)).
                                   AppendCallback(() =>
                                   {
            ...
            {
                m_WordsTextTMP.color = new Color(m_WordsTextTMP.color.r, m_WordsTextTMP.color.g, m_WordsTextTMP.color.b, 0f);
                m_WordsTextTMP.transform.rectTransform().anchoredPosition = new Vector2(0f, -60f);
                DOTween.Sequence().Append(m_WordsTextTMP.DOColor(new Color(m_WordsTextTMP.color.r, m_WordsTextTMP.color.g, m_WordsTextTMP.color.b, 1f), fadeDuration))
                                  .Insert(0, m_WordsTextTMP.transform.rectTransform().DOLocalMoveY(0, fadeDuration))
                                  .SetUpdate(true);
                DOTween.Sequence().AppendInterval(fadeDuration + m_Duration).
                                   Append(m_WordsTextTMP.DOColor(new Color(m_WordsTextTMP.color.r, m_WordsTextTMP.color.g, m_WordsTextTMP.color.b, 0f), fadeDuration)).
                                   AppendCallback(() =>
                                   {
                                       if (m_OverCallback != null)
                                       {
