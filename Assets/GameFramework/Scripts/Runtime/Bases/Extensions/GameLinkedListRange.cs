...
namespace Honor.Runtime
{
    ...
    public class GameLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        {
            private readonly GameLinkedListRange<T> _mGameLinkedListRange;
            ...
            internal Enumerator(GameLinkedListRange<T> range)
            {
                ...
                _mGameLinkedListRange = range;
                m_Current = _mGameLinkedListRange.m_First;
            ...
            {
                if (m_Current == null || m_Current == _mGameLinkedListRange.m_Terminal)
                {
                    return false;
                }
