 ...
 * All Rights Reserved.
 * -------------------------------------------------------------
 * filename:  AorTextLocalizing.cs
 * author:    云毅
 * created:   2026
 * descrip:   UI 文本多语言本地化组件 | 支持 Text/TMP | 自动监听语言切换
 ***************************************************************/
...
namespace Honor.Runtime
{
    ...
    public class AorTextLocalizing : MonoBehaviour
    {
        ...
        public string LocalizingKeyName
        {
            ...
            get => m_LocalizingKeyName;
        }
        #endregion

        #region Property - 字体标记
        /// <summary>
        /// 多语言字体标记（只读）
        /// </summary>
        public string LocalizingFontMark => m_LocalizingFontMark;
        #endregion

        #region Property - 本地化文本内容
        /// <summary>
        /// 当前加载的本地化文本内容（只读）
        /// </summary>
        public string LocalizingValue => m_LocalizingValue;
        #endregion

        #region Property - 语言类型
        /// <summary>
        /// 当前语言类型，可读写
        /// </summary>
