...
namespace Honor.Runtime
{
    public partial class AorTextPicMixed : TextPic
    {
        ...
        /// 正则过滤器-别名格式
        /// </summary>
        private static readonly Regex s_PicRegexOnResDefFormat = new Regex(AorTxt.Format(@"{0}(?<fname>[\w]+){1}((([0-9]\d*)(.)([0-9]\d*))|([0-9]\d*)){2}((([0-9]\d*)(.)([0-9]\d*))|([0-9]\d*)){3}((([0-9]\d*)(.)([0-9]\d*))|([0-9]\d*)){4}", IDENTIFIERS_START, SEPARATOR, SEPARATOR, SEPARATOR, IDENTIFIERS_END));
