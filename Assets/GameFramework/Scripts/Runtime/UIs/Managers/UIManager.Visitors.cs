...
namespace Honor.Runtime
{
    public sealed partial class UIManager
    {
        ...
        public bool BlockModalUIsSwitch
        {
            set
            {
                m_BlockModalUIsSwitch = value;
            }
            get
            {
                return m_BlockModalUIsSwitch;
            }
        }
        ...
        public bool BlockAllUIsKeyUpSwitch
        {
            set
            {
                m_BlockAllUIsKeyUpSwitch = value;
            }
            get
            {
                return m_BlockAllUIsKeyUpSwitch;
            }
        }
        ...
        public UIConnectionWaitingView ConnectionWaitingUIConnection
        {
            get
            {
                return _mConnectionWaitingUIConnection;
            }
        }
        ...
        public int WaitingUIRefCount
        {
            set
            {
                m_WaitingUIRefCount = value;
            }
            get
            {
                return m_WaitingUIRefCount;
            }
        }
