...
namespace Honor.Runtime
{
    ...
    public class GameMultiDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, GameLinkedListRange<TValue>>>,IEnumerable
    {
        ...
        IEnumerator<KeyValuePair<TKey, GameLinkedListRange<TValue>>>
            IEnumerable<KeyValuePair<TKey, GameLinkedListRange<TValue>>>.GetEnumerator()
        {
