...
namespace Honor.Runtime
{
    public class AorItemPosMgr
    {
        ...
        public AorItemPosMgr(int index, float itemDefaultSize)
        {
            mGroupIndex = index;
    ...
    public class ItemPosMgr
    {
        ...
        List<AorItemPosMgr> mItemSizeGroupList = new List<AorItemPosMgr>();
        ...
        public void SetItemMaxCount(int maxCount)
        {
            ...
            else if (count < needMaxGroupCount)
            {
                ...
                for (int i = 0; i < d; ++i)
                {
                    AorItemPosMgr tGroup = new AorItemPosMgr(count + i, mItemDefaultSize);
        ...
        public void SetItemSize(int itemIndex, float size)
        {
            ...
            AorItemPosMgr tGroup = mItemSizeGroupList[groupIndex];
        ...
        public bool GetItemIndexAndPosAtGivenPos(float pos, ref int index, ref float itemPos)
        {
            ...
            {
                int mid = (low + high) / 2;
                AorItemPosMgr tGroup = mItemSizeGroupList[mid];
        ...
        public void Update(bool updateAll)
        {
            ...
            {
                loopCount++;
                AorItemPosMgr tGroup = mItemSizeGroupList[i];
                mDirtyBeginIndex++;
