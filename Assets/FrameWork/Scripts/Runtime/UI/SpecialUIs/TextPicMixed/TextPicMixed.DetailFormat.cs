...
namespace Honor.Runtime
{
    public partial class TextPicMixed : TextPic
    {
        ...
        /// 正则过滤器-详情格式
        /// </summary>
        private static readonly Regex s_PicRegexOnDetailFormat = new Regex(Txt.Format(@"{0}(([\w]+/)*[\w]+){1}(?<fname>[\w]+){2}((([0-9]\d*)(.)([0-9]\d*))|([0-9]\d*)){3}((([0-9]\d*)(.)([0-9]\d*))|([0-9]\d*)){4}((([0-9]\d*)(.)([0-9]\d*))|([0-9]\d*)){5}", IDENTIFIERS_START, SEPARATOR, SEPARATOR, SEPARATOR, SEPARATOR, IDENTIFIERS_END));
