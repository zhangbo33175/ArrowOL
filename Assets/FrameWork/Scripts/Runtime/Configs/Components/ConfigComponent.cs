...
namespace Honor.Runtime
{
    public sealed partial class ConfigComponent
    {
        ...
        {
            TextAsset configJsonAsset =(TextAsset)AssetManager.Instance.LoadAssetSync("BinaryAsset", abPath, assetName);
            string contentString =Converter.GetString(Encryption.GetQuickXorBytes(configJsonAsset.bytes,ConfigManager.Instance.s_ConfigEncrytionKey));
        ...
        public bool GetBool(string configName)
        {
            ...
            return configData[LauncherManager.Instance.DevelopMode ? 0 : 1].BoolValue;
        }
        ...
        public int GetInt(string configName)
        {
            ...
            return configData[LauncherManager.Instance.DevelopMode ? 0 : 1].IntValue;
        }
        ...
        public float GetFloat(string configName)
        {
            ...
            return configData[LauncherManager.Instance.DevelopMode ? 0 : 1].FloatValue;
        }
        ...
        public string GetString(string configName)
        {
            ...
            return configData[LauncherManager.Instance.DevelopMode ? 0 : 1].StringValue;
        }

        /// <summary>
        /// 是否是开发模式
        /// </summary>
        public bool IsDevelopMode => LauncherManager.Instance != null && LauncherManager.Instance.DevelopMode;

        /// <summary>
        /// 是否使用本地服务器
        /// </summary>
        public bool IsLocalServer => LauncherManager.Instance != null && LauncherManager.Instance.IsLocalServer;
    }
}