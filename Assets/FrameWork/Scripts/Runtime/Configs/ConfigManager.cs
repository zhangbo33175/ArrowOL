...
namespace Honor.Runtime
{
    public sealed partial class ConfigManager:Singleton<ConfigManager>
    {
        ...
        {
            m_ConfigComponent.LoadConfigs(GamePathUtils.Json.GetRootDirectoryRelativePath(), "Configs");
        }
        ...
        {
            return m_ConfigComponent.GetAllConfigNames();
        }
        ...
        public bool HasConfig(string configName, bool onPlatform = false)
        {
            ...
            return m_ConfigComponent.HasConfig(configName);
        }
        ...
        public bool RemoveConfig(string configName, bool onPlatform = false)
        {
            ...
            return m_ConfigComponent.RemoveConfig(configName);
        }
        ...
        public bool GetBool(string configName, bool onPlatform = false)
        {
            ...
            return m_ConfigComponent.GetBool(configName);
        }
        ...
        public int GetInt(string configName, bool onPlatform = false)
        {
            ...
            return m_ConfigComponent.GetInt(configName);
        }
        ...
        public float GetFloat(string configName, bool onPlatform = false)
        {
            ...
            return m_ConfigComponent.GetFloat(configName);
        }
        ...
        public string GetString(string configName, bool onPlatform = false)
        {
            ...
            return m_ConfigComponent.GetString(configName);
        }
        ...
        public string GetCurBuildPlatformName()
        {
            ...
            return "WebGL";
#else
            return LauncherManager.Instance.IsAmazonStore ? "Amazon" : "Android";
#endif
        }
