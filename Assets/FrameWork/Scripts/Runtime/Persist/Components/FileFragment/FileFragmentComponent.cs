...
{
    /// <summary>
    /// FileFragmentComponent.Visitors
    /// </summary>
    public sealed partial class FileFragmentComponent
    {
        ...
        public FileFragmentComponent()
        {
            ...
            for (int index = 0; index < fileFragmentFullPaths.Length; index++)
            {
                ...
                string name = m_FilePaths[index]
                    .Substring(startIndex, m_FilePaths[index].Length - startIndex - ".dat".Length);
