...
namespace Honor.Runtime
{
    public class PrefabInstanceGOBehaviour: MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            AssetManager.Instance.m_LoadPrefabComponent.AddAssetRef(ABPath, AssetName, gameObject);
        }

        void OnDestroy()
        {
            // 被动销毁，保证引用计数正确
            AssetManager.Instance.m_LoadPrefabComponent.Destroy(gameObject, RightNowDestroyOnAsset);
        }
