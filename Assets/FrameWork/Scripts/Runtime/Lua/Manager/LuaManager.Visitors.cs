...
namespace Honor.Runtime
{
    public partial class LuaManager
    {
        ...
        /// Luac加密秘钥Key
        /// </summary>
        public byte[] s_LuacEncrytionKey ={ 110, 52, 63, 5, 7, 13, 245, 206, 178, 221, 143, 135, 53, 41, 29, 3, 197, 77, 103, 82 };

        /// <summary>
        /// Lua运行时分析模式
        /// 仅Editor中有效
        /// </summary>
        [SerializeField] private bool m_LuaRuntimeProfilerMode;
        ...
        /// 最近一次的GC调用时间
        /// </summary>
        internal float m_LastGCTime = 0f;
